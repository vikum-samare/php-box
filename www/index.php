<!DOCTYPE html>
<html class="cspio" xmlns="http://www.w3.org/1999/html">
<head>
    <!---
    ...
    <link rel="stylesheet"
          href="https://fonts.gstatic.com/l/font?kit=Cn-tJt-LUxZV2ICofzrQFC41xuIka3OblBeUpZfyZLUSd01BWDbv8KJGHjME&skey=93c2fdf69b410576&v=v4">
    <!-- Favicon -->
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="assets/faviconsfavicon-32x32.png">
    ...
    <style type="text/css">
        ...
        html{
            height:100%;
            background: #ffffff url("/assets/Animation001.gif"); no-repeat center bottom fixed;
...
<div id="cspio-page">
    <div id="cspio-content">
        <p>We are currently developing an Awesome Website for you to access...</p>
